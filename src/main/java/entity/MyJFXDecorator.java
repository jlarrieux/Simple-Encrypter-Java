...
public class MyJFXDecorator extends VBox {
 ...
 */
     ...
     */
        ...
        public MyJFXDecorator(Stage stage, Node node, boolean fullScreen, boolean max, boolean min) {
            ...
            titleContainer.setPadding(new Insets(4));
            titleContainer.setAlignment(Pos.CENTER_LEFT);
            titleContainer.getChildren().add(title);
            titleContainer.setPrefWidth(titleContainer.getMaxWidth());
//            titleContainer.setPadding(new Insets(0,100,0,0));

            buttonsContainer.getChildren().add(titleContainer);
